                ...
                <TableBody>
                  {this.state.filesDepurado.map(rows => {
                     ...
                     // console.log("esto es subtring de nombre",subtring_nombre)
                      ...
                      return( 
                     <ExcelExport data={rows} ref={(exporter) => this._export = exporter}>
                    <GridColumn field="Correo"  > {sbstrg} </GridColumn>
                    {/* <GridColumn field="Nombre" title="Product ID" width="50px" />
                    <GridColumn field="Empresa" title="Product Name" width="350px" />
                    <GridColumn field="Telefono" title="Price" /> */}
...
{/* 
                  ...
                  <TableCell component="th" scope="row">
                    {sbstrg}
                      ...
                      <TableCell field="empresa"  >{rows[0].Empresa}</TableCell>
                      <TableCell field="telefono" >{rows[0].Telefono}</TableCell>
